        ...
        <Grid container spacing={2}>
            ...
            <div className="sidenavs">
              ...
              <div className="meals">
                ...
                <div className="sortdiv">
                  ...
                  />
                  <h4>
                    <Link to="/happymeal">Happy Meal</Link>
                  </h4>
                </div>
                ...
                <div className="sortdiv">
                  ...
                  />
                  <h4>
                    <Link to="/snacks">Qəlyanaltılar</Link>
                  </h4>
                </div>
                ...
                <div className="sortdiv" style={{ display: "flex" }}>
                  ...
                  />
                  <h4>
                    <Link to="/sweets">Şirniyyat və kokteyllər</Link>
                  </h4>
                </div>
                ...
                <div className="sortdiv" style={{ display: "flex" }}>
                  ...
                  />
                  <h4>
                    <Link to="/hotdrinks">İsti içkilər</Link>
                  </h4>
                </div>
          ...
          <Grid item xs={10} className="Gridcard">
            <div className="cards">
              ...
              <Grid className="contgrid" container spacing={2}>
                {meals &&
                  meals.map((meal) => {
                    return (
                      <Grid
